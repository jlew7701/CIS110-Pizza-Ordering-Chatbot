...
print("I am going to ask you some questions. After each response, you must hit enter.")

userName = input("\nEnter your name:  ")
while len(userName) == 0:
    userName = input("Name cannot be blank! Please enter your name:  ")
    
if userName.lower() == "jennifer essman":
...
while keepGoing.lower() == "y":
    ...
    while len(crustType) == 0:
        crustType = input("Crust cannot be blank! Please enter crust type:  ")
        
    quantity = input("\nHow many of these do you want? Enter a numeric value:  ")
